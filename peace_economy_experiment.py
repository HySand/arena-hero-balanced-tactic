...
ARCHIVE_FILE = ROOT / ".peace_economy_telemetry.jsonl"
STATE_FILE = ROOT / ".peace_economy_experiment_state.json"
PLAN_FILE = ROOT / "peace_economy_17_1_1.json"
...
def append_telemetry(
    ...
    *,
    ...
    with _exclusive_lock(lock_path):
        ...
        block_ticks = int(experiment.get("block_ticks", 0))
        warmup_samples = int(experiment.get("warmup_samples", 24))
        phase = "warmup" if block_ticks < warmup_samples else "measure"
        record = {
            "version": 1,
            "recorded_at": _now(),
        ...
        record["measurement_eligible"] = bool(
            ...
            and phase == "measure"
            and record["workers"] == 17
            and record["vanguards"] == 1
            and record["rangers"] == 1
            and record["posture"] == "ECONOMY"
        )
...
def _apply_candidate(
    ...
    *,
    ...
    save_strategy_config(updated, config_path)
...
def _advance_experiment(
    ...
    *,
    ...
    if _measurement_eligible(record):
    ...
    warmup = int(state.get("warmup_samples", 24))
    ...
    forced = int(state["block_ticks"]) >= warmup + max_measurement
