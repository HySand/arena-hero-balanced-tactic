/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc` (hash: 8889dc98d9b5cdcece887b46628bcb19)
...
interface __BaseEnv_Env {
	...
	PYTHON_STRATEGY: DurableObjectNamespace /* StrategyPlanner from arena-hero-python-strategy */;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "ArenaHeroAgent" | "ArenaHeroState";
	}
