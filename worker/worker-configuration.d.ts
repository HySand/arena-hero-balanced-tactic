/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc` (hash: 20e3a2d4e31a35e412bffbcaa326cb37)
// Runtime types generated with workerd@1.20260801.1 2026-08-10 nodejs_compat
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	AGENT: DurableObjectNamespace<import("./src/index").ArenaHeroAgent>;
	STATE: DurableObjectNamespace<import("./src/index").ArenaHeroState>;
	BROKER: DurableObjectNamespace<import("./src/index").ArenaHeroCommandBroker>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "ArenaHeroAgent" | "ArenaHeroState" | "ArenaHeroCommandBroker";
	}
